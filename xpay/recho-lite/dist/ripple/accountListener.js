...
const sendWebNotification_1 = require("../service/sendWebNotification");
const startListeningAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    socket.addEventListener('message', (event) => {
        ...
        (0, sendWebNotification_1.sendNotification)(event.data);
    });
    socket.addEventListener('close', (event) => {
        console.log('Disconnected...');
        setTimeout(exports.startListeningAccounts, 10000);
    });
    let autoid_n = 0;
    ...
    function do_subscribe() {
        return __awaiter(this, void 0, void 0, function* () {
            const sub_response = yield api_request({
                command: "subscribe",
                accounts: [process.env.ACCOUNT_NO]
            });
